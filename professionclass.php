    ...
    <div class="background_gray">
        <div class="wrap background_white">
            ...
            <ul class="classtime_ul">
                <li><h3><img src="img/professionclass/jphuman/jphuman-13.png?123" alt=""></h3><h4>日本人形雕塑班</h4><p>課程分為初、中、上、高、4個科別共有作品14個。(不含創作)此科所有證書費用需日幣69,000元。作品需拍照寄日本才可申請證書，高等科檢定的作品需將實物寄到日本檢定。
                        <br>(此課程使用的黏土是LADOLL、布黏土，全以人物雕塑為主)。</p><a href="professionclass_jphuman.php">了解更多</a></li>
                <li><h3><img src="img/professionclass/jpchild/jpchild-4.png?123" alt=""></h3><h4>日本兒童證書班</h4><p>課程分為A、B、C三級。共有作品40個作品。此科所有證書費用約需NT8,400元。<br>作品需拍照寄日本才可申請證書。<br>(PADICO所有粘土幾乎全部運用在其中,課程以趣味及實用性為主)。</p><a href="professionclass_jpchild.php">了解更多</a></li>
