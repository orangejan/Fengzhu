 ...
 <div><img class="img" src="img/IMG_0067.JPG" alt=""></div>
    <div class="background_gray">
        <div class="wrap background_white">
            ...
            <main class="wrap">
                <div><img class="img_up" src="img/IMG_0067.JPG" alt="劉鳳珠美術・黏土才藝教室"></div>
            ...
            <ul class="classtime_ul">
                <li><h3><img src="img/teacher/Fengzhu.png" alt="劉鳳珠老師"></h3><h4>師資介紹</h4><p>劉鳳珠老師致力於兒童美術繪畫以及黏土雕塑的教學，藉由其十來年的豐富教學經驗，以循序漸進的方式讓孩子們學會自己動手玩創意，除了從生活中激發潛能與創造力，並且提供基礎美學涵養的啟蒙，進而豐富孩童的課外生活與培養相關的才藝專長。</p><a href="aboutus_teacher.php">了解更多</a></li>
                <li><h3><img src="img/location/location-2.jpg" alt="劉鳳珠美術・黏土才藝教室"></h3><h4>環境介紹</h4><p>「劉鳳珠美術・黏土才藝教室」座落於基隆市安樂區人文薈萃的安樂路上，鄰近安樂圖書館及建德國小。<br>基於實踐本機構致力推廣之造型/視覺藝術教育理念，「劉鳳珠美術・黏土才藝教室」提供一個用心經營的環境，讓學生體驗專業、舒適的藝術創作學習空間。</p><a href="aboutus_location.php">了解更多</a></li>
            </ul>
        </div>
    </div>
